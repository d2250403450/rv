...
/**
 *	This function is used to print a string to UART 
 * 	
 */
void sys_printf(int sysno, char* fmt, ...)
{
	va_list ap;
	va_start(ap, fmt);
 ...
 */ 
char *sys_readline(int sysno, const char *prompt)
{
	return readline(prompt);
}
extern struct Env_list env_sched_list[2];
extern int cur_sched;
void sys_env_create(int sysno, u32 env_va)
{
